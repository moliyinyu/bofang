...
//		    alert("a");
		...
		timer2 = setInterval(function(){
			...
			box3.style.left = a*(box2.offsetWidth-box3.offsetWidth)+"px";
...
//  		console.log((box.offsetLeft+box3.offsetWidth+1));
    		//左边
    		if(x<=(aa.offsetLeft+obox.offsetLeft+1)){
    			box3.style.left = 0+"px";
    		}else if(x>=(aa.offsetLeft+box2.offsetWidth+1)){
    			box3.style.left = 200+"px";
    		}else{
    			box3.style.left = x-obox.offsetLeft-aa.offsetLeft-1+"px";
    		} 
